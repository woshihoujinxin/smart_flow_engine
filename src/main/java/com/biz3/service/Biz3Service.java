package com.biz3.service;

import com.biz3.config.FlowMappings;
import com.biz3.config.HandlerMappings;
 ...
 */
public class Biz3Service extends AbstractThirdPartyService {

    private static Logger logger = LoggerFactory.getLogger(Biz3Service.class);
